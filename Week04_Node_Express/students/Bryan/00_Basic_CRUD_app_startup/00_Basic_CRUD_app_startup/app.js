...
//MIDDLEWARE FOR SERVER TO READ POST FROM CLIENT
...
app.use(function(req, res, next) {
    ...
    //THIS ALLOWS EXTERNAL SITE TO ACCESS SERVER
...
app.get('/projects', function(req, res) {
    ...
    // using req.query instead of req.body -- req.body used with POST, .query with GET
...
app.post('/register', function(req, res) {
    ...
    //if path does not exist, do this:
    if(!fs.existsSync('data/' + req.body.email)){
        //prepare an empty (stringified) array
