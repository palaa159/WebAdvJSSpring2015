...
app.get('/projects', function(req, res) {
    // Fetch data from a file, req.query is for get
    fs.readFile('data/' + req.query.email, 'utf8', function(err, data) {
        if (err) {
...
app.post('/register', function(req, res) {
    //data from input field, req.body is for post
    //console.log(req.body);
    console.log(req.body.email);

    //! inverts condition
    if(!fs.existsSync('data/' + req.body.email)){
        // path, an empty array (only strings),  
